...
class addPacienteAlojamento extends StatefulWidget {
  @override
  _addPacienteAlojamentoState createState() => _addPacienteAlojamentoState();
}

class _addPacienteAlojamentoState extends State<addPacienteAlojamento> {
  ...
  Firestore.instance.collection("alojamentoConjunto").document("pacientes").collection("infoPacientes").add(
     {
       "nome" : nome,
