...
import 'addSetores/addPacienteCasaDaGestante.dart';

class casaDaGestantePage extends StatefulWidget {
  @override
  _casaDaGestantePageState createState() => _casaDaGestantePageState();
}

class _casaDaGestantePageState extends State<casaDaGestantePage> {
  Future getPacientes() async {
    QuerySnapshot s = await Firestore.instance
        .collection("casaDaGestante")
        .document("pacientes")
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => addPacienteCasaDaGestante()));
        },
      ),
      body: FutureBuilder(
          future: getPacientes(),
