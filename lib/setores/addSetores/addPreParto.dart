...
class addPacientePreParto extends StatefulWidget {
  @override
  _addPacientePrePartoState createState() => _addPacientePrePartoState();
}

class _addPacientePrePartoState extends State<addPacientePreParto> {
  ...
  void salvar (String nome, String nLeito , String iniciaisDoNome, String idade, String idadeGestacional, String queixas, String municipioDeOrigem ) {
    ...
    Firestore.instance.collection("preParto").document("pacientes").collection("infoPacientes").add(
        {
          "nome" : nome,
