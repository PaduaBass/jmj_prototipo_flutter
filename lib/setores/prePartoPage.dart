...
import 'addSetores/addPreParto.dart';

class prePartoPage extends StatefulWidget {
  @override
  _prePartoPageState createState() => _prePartoPageState();
}

class _prePartoPageState extends State<prePartoPage> {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => addPacientePreParto()));
        },
      ),
      body: FutureBuilder(
          future: getPacientes(),
