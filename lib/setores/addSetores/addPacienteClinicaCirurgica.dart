...
class addPacienteClinicaCirurgica extends StatefulWidget {
  @override
  _addPacienteClinicaCirurgicaState createState() => _addPacienteClinicaCirurgicaState();
}

class _addPacienteClinicaCirurgicaState extends State<addPacienteClinicaCirurgica> {
  ...
  void salvar (String nome, String nLeito , String iniciaisDoNome, String idade, String idadeGestacional, String queixas, String municipioDeOrigem ) {
    ...
    Firestore.instance.collection("clinicaCirurgica").document("pacientes").collection("infoPacientes").add(
        {
          "nome" : nome,
