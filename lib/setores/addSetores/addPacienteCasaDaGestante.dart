...
class addPacienteCasaDaGestante extends StatefulWidget {
  @override
  _addPacienteCasaDaGestanteState createState() => _addPacienteCasaDaGestanteState();
}

class _addPacienteCasaDaGestanteState extends State<addPacienteCasaDaGestante> {
  ...
  void salvar (String nome, String nLeito , String iniciaisDoNome, String idade, String idadeGestacional, String queixas, String municipioDeOrigem ) {
    ...
    Firestore.instance.collection("casaDaGestante").document("pacientes").collection("infoPacientes").add(
        {
          "nome" : nome,
